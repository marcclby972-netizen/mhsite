  ...
  return (
    <div className="w-full max-w-2xl mx-auto">
      <motion.div
        ...
        className="bg-[#151514]/50 backdrop-blur-md rounded-2xl p-8 border border-white/10"
      >
        {/* Header */}
        ...
        <AnimatePresence mode="wait">
          ...
          {step === 'confirmation' && (
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Votre rendez-vous a été ajouté à notre calendrier. 
          ...
          {step === 'error' && (
            ...
            >
              ...
              <p className="text-gray-400 mb-6">
                Une erreur s'est produite lors de la création de votre rendez-vous. 
